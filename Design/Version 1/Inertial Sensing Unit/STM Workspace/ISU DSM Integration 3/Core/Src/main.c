...
//		HAL_UART_Transmit(&huart4, "20-11-2023,", 11, 100);
//		memset(tempbuff,'\0',6);
//		gcvt(trans1.tlm1.Ax,4,tempbuff);
//		strcat(tempbuff,",");
//		HAL_UART_Transmit(&huart4, tempbuff, strlen(tempbuff), 100);
//		memset(tempbuff,'\0',6);
//		strcat(tempbuff,",");
//		gcvt(trans1.tlm1.Ay,4,tempbuff);
//		strcat(tempbuff,",");
//		HAL_UART_Transmit(&huart4, tempbuff, strlen(tempbuff), 100);
//		memset(tempbuff,'\0',6);
//		gcvt(trans1.tlm1.Az,4,tempbuff);
//		strcat(tempbuff,",");
//		HAL_UART_Transmit(&huart4, tempbuff, strlen(tempbuff), 100);
//		HAL_UART_Transmit(&huart4, "9.25,", 6, 100);
//		HAL_UART_Transmit(&huart4, "0.01,", 6, 100);
//		gcvt(trans1.tlm1.CPM_Voltage,4,tempbuff);
//		strcat(tempbuff,",");
//		HAL_UART_Transmit(&huart4, tempbuff, strlen(tempbuff), 100);
//		gcvt(trans1.tlm1.CPM_Current,4,tempbuff);
//		strcat(tempbuff,",");
//		HAL_UART_Transmit(&huart4, tempbuff, strlen(tempbuff), 100);
//		HAL_UART_Transmit(&huart4, "22.4,", 7, 100);
//		memset(tempbuff,'\0',6);
//		gcvt(trans1.tlm1.Altitude,4,tempbuff);
//		strcat(tempbuff,",");
//		HAL_UART_Transmit(&huart4, tempbuff, strlen(tempbuff), 100);
//		memset(tempbuff,'\0',6);
//		gcvt(Pressure,4,tempbuff);
//		strcat(tempbuff,",");
//		HAL_UART_Transmit(&huart4, tempbuff, strlen(tempbuff), 100);
//		HAL_UART_Transmit(&huart4, "0,", 3, 100);
//		memset(tempbuff,'\0',6);
//		gcvt(trans1.tlm1.Gx,4,tempbuff);
//		strcat(tempbuff,",");
//		HAL_UART_Transmit(&huart4, tempbuff, strlen(tempbuff), 100);
//		memset(tempbuff,'\0',6);
//		gcvt(trans1.tlm1.Gy,4,tempbuff);
//		strcat(tempbuff,",");
//		HAL_UART_Transmit(&huart4, tempbuff, strlen(tempbuff), 100);
//		memset(tempbuff,'\0',6);
//		gcvt(trans1.tlm1.Gz,4,tempbuff);
//		strcat(tempbuff,",");
//		HAL_UART_Transmit(&huart4, tempbuff, strlen(tempbuff), 100);
//		HAL_UART_Transmit(&huart4, "0,", 3, 100);
//		HAL_UART_Transmit(&huart4, "0", 3, 100);
